...
object BlockEntities extends AbstractRegister[BlockEntityType[_]] {
  ...
  val BOOK_CAPACITOR: RegistryObject[BlockEntityType[BookCapacitorBlockEntity]] = REGISTER.register("book_capacitor_block_entity", () => BlockEntityType.Builder.of(new BookCapacitorBlockEntity(_, _), Blocks.BOOK_CAPACITOR.get()).build(null))
  val BOOK_CRAFTING_CORE: RegistryObject[BlockEntityType[BookCraftingCoreBlockEntity]] = REGISTER.register("book_crafting_core_block_entity", () => BlockEntityType.Builder.of(new BookCraftingCoreBlockEntity(_, _), Blocks.BOOK_CRAFTING_CORE.get()).build(null))
  val BOOK_STAND: RegistryObject[BlockEntityType[BookStandBlockEntity]] = REGISTER.register("book_stand_block_entity", () => BlockEntityType.Builder.of(new BookStandBlockEntity(_, _), Blocks.BOOK_STAND.get()).build(null))
}
