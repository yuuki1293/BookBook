...
import com.yuuki1293.bookbook.common.block.entity.{BookCapacitorBlockEntity, BookCraftingCoreBlockEntity, BookFurnaceBlockEntity, BookGeneratorBlockEntity}
