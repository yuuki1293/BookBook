...
object Blocks extends AbstractRegister[Block] {
  ...
  val BOOK_STAND: RegistryObject[BookStandBlock] = REGISTER.register("book_stand", () => new BookStandBlock(default().requiresCorrectToolForDrops().strength(3.0F).lightLevel(_ => 7)))
}