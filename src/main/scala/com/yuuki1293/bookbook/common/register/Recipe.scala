...
import net.minecraft.world.item.crafting.{RecipeSerializer, SimpleRecipeSerializer}
...
object Recipe {
  ...
  val WATERPROOFED_BOOK: RegistryObject[RecipeSerializer[_]] = RECIPE.register("waterproofed_book", () => new SimpleRecipeSerializer[WaterproofedBookRecipe](new WaterproofedBookRecipe(_)))
